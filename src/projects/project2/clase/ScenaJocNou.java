...
public class ScenaJocNou extends JPanel{
	...
	{
	    try {                
	        image1 = ImageIO.read(new File("src//projects//project2//imagini//oras.jpg"));
	    } catch (IOException ex) {
	    }

	    try {                
	        image2 = ImageIO.read(new File("src//projects//project2//imagini//money.png"));
	    } catch (IOException ex) {
	    }
	    
	    try {                
	        image3 = ImageIO.read(new File("src//projects//project2//imagini//masina.png"));
	    } catch (IOException ex) {
	    }
	}
